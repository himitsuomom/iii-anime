---
description: SDLC Phase 9 - 結合・リリース
...
# SDLC Phase 9: 結合・リリース

適用思想: **リリースチェックリスト + ロールバック前提**
...
生成プロンプトに従って成果物を作成し、`docs/sdlc/phase-9/` 配下に保存する。
...
作成したファイル一覧を提示する。次のフェーズ: /sdlc-phase-10
