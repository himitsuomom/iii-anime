// Port of git compact_diff: file headers, hunk-level truncation, +/-/context counting.
import { GIT_DIFF_HUNK_MAX_LINES, named } from '../constants'

export const gitDiff = named('git-diff', (diff: string, maxLines = 500): string => {
  const result: string[] = []
  let currentFile = ''
  let added = 0
  let removed = 0
