// Error classification + cooldown config (ported from 9router errorConfig.js).

// OpenAI-compatible error types (client-facing).
...
// Hard cap for provider-reported rate limit cooldown.
