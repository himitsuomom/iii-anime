...
name: jsbeeb
description: >-
  Provides development guide for JavaScript BBC Micro emulator with build and testing
  instructions, architecture documentation, and debugging workflows. (CLAUDE.md File, via
  awesome-claude-code).
---

# JSBeeb

- **Author:** [mattgodbolt](https://github.com/mattgodbolt)
- **License:** GPL-3.0
