...
description: >-
  Provides a well-structured set of commands for publishing and maintaining a blogging platform,
  including commands for creating posts, managing categories, and handling media files. (Workflow
  / Knowledge Guide, via awesome-claude-code).
---

# Blogging Platform Instructions

- **Author:** [cloudartisan](https://github.com/cloudartisan)
- **License:** CC-BY-SA-4.0
- **Source:** https://github.com/cloudartisan/cloudartisan.github.io/tree/main/.claude/commands
