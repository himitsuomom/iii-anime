...
description: >-
  A tailored workflow for enabling automated UI/UX design review, including specialized sub
  agents, slash commands, `CLAUDE.md` excerpts, and more. Covers a broad range of criteria from
  responsive design to accessibility. (Workflow / Knowledge Guide, via awesome-claude-code).
---

# Design Review Workflow

- **Author:** [Patrick Ellis](https://github.com/OneRedOak)
- **License:** MIT
...
- **Category:** Workflow / Knowledge Guide
...
- [`design-review-claude-md-snippet.md`](./design-review-claude-md-snippet.md)
- [`design-review-slash-command.md`](./design-review-slash-command.md)
