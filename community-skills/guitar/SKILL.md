...
name: guitar
description: >-
  Serves as development guide for Guitar Git GUI Client with build commands for various platforms,
  code style guidelines for contributing, and project structure explanation. (CLAUDE.md File, via
  awesome-claude-code).
---

# Guitar

- **Author:** [soramimi](https://github.com/soramimi)
- **License:** GPL-2.0
