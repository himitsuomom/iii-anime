...
name: perplexity-mcp
description: >-
  Offers clear step-by-step installation instructions with multiple configuration options,
  detailed troubleshooting guidance, and concise architecture overview of the MCP protocol.
  (CLAUDE.md File, via awesome-claude-code).
---

# Perplexity MCP

- **Author:** [Family-IT-Guy](https://github.com/Family-IT-Guy)
- **License:** ISC
- **Source:** https://github.com/Family-IT-Guy/perplexity-mcp/blob/main/CLAUDE.md
