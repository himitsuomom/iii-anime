...
name: note-companion
description: >-
  Provides detailed styling isolation techniques for Obsidian plugins using Tailwind with custom
  prefix to prevent style conflicts and practical troubleshooting steps. (CLAUDE.md File, via
  awesome-claude-code).
---

# Note Companion

- **Author:** [different-ai](https://github.com/different-ai)
- **License:** MIT
- **Source:** https://github.com/different-ai/note-companion/blob/master/CLAUDE.md
