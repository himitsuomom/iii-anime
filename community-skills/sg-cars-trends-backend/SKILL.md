...
description: >-
  Provides comprehensive structure for TypeScript monorepo projects with detailed commands for
  development, testing, deployment, and AWS/Cloudflare integration. (CLAUDE.md File, via
  awesome-claude-code).
---

# SG Cars Trends Backend

- **Author:** [sgcarstrends](https://github.com/sgcarstrends)
- **License:** MIT
- **Source:** https://github.com/sgcarstrends/backend/blob/main/CLAUDE.md
