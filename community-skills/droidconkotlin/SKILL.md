...
name: droidconkotlin
description: >-
  Delivers comprehensive Gradle commands for cross-platform Kotlin Multiplatform development with
  clear module structure and practical guidance for dependency injection. (CLAUDE.md File, via
  awesome-claude-code).
---

# DroidconKotlin

- **Author:** [touchlab](https://github.com/touchlab)
- **License:** Apache-2.0
