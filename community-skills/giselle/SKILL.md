...
name: giselle
description: >-
  Provides detailed build and test commands using pnpm and Vitest with strict code formatting
  requirements and comprehensive naming conventions for code consistency. (CLAUDE.md File, via
  awesome-claude-code).
---
...
- **License:** Apache-2.0
- **Source:** https://github.com/giselles-ai/giselle/blob/main/CLAUDE.md
