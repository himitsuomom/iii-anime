...
name: course-builder
description: >-
  Enables real-time multiplayer capabilities for collaborative course creation with diverse tech
  stack integration and monorepo architecture using Turborepo. (CLAUDE.md File, via
  awesome-claude-code).
---

# Course Builder

- **Author:** [badass-courses](https://github.com/badass-courses)
- **License:** MIT
