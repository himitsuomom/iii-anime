...
name: cursor-tools
description: >-
  Creates a versatile AI command interface supporting multiple providers and models with flexible
  command options and browser automation through "Stagehand" feature. (CLAUDE.md File, via
  awesome-claude-code).
---

# Cursor Tools

- **Author:** [eastlondoner](https://github.com/eastlondoner)
- **License:** MIT
- **Source:** https://github.com/eastlondoner/cursor-tools/blob/main/CLAUDE.md
