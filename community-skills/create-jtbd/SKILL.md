...
name: create-jtbd
description: >-
  You are an experienced Product Manager. Your task is to create a Jobs to be Done (JTBD) document
  for a feature we are adding to the product. (Slash Command, via awesome-claude-code).
---
