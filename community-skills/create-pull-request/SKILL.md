...
description: >-
  Provides comprehensive PR creation guidance with GitHub CLI, enforcing title conventions,
  following template structure, and offering concrete command examples with best practices. (Slash
  Command, via awesome-claude-code).
---

# /create-pull-request

- **Author:** [liam-hq](https://github.com/liam-hq)
- **License:** Apache-2.0
