...
name: pareto-mac
description: >-
  Serves as development guide for Mac security audit tool with build instructions, contribution
  guidelines, testing procedures, and workflow documentation. (CLAUDE.md File, via
  awesome-claude-code).
---

# Pareto Mac

- **Author:** [ParetoSecurity](https://github.com/ParetoSecurity)
- **License:** GPL-3.0
