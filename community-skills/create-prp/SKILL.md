...
name: create-prp
description: >-
  Creates product requirement plans by reading PRP methodology, following template structure,
  creating comprehensive requirements, and structuring product definitions for development. (Slash
  Command, via awesome-claude-code).
---

# /create-prp

- **Author:** [Wirasm](https://github.com/Wirasm)
- **License:** MIT
