...
name: tpl
description: >-
  Details Go project conventions with comprehensive error handling recommendations, table-driven
  testing approach guidelines, and modernization suggestions for latest Go features. (CLAUDE.md
  File, via awesome-claude-code).
---

# TPL

- **Author:** [KarpelesLab](https://github.com/KarpelesLab)
- **License:** MIT
- **Source:** https://github.com/KarpelesLab/tpl/blob/master/CLAUDE.md
