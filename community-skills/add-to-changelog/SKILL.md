...
description: >-
  Adds new entries to changelog files while maintaining format consistency, properly documenting
  changes, and following established project standards for version tracking. (Slash Command, via
  awesome-claude-code).
---

# /add-to-changelog

- **Author:** [berrydev-ai](https://github.com/berrydev-ai)
- **License:** MIT
