...
description: >-
  Provides comprehensive Gradle commands for IntelliJ plugin development with platform-specific
  coding patterns, detailed package structure guidelines, and clear internationalization
  standards. (CLAUDE.md File, via awesome-claude-code).
---

# AI IntelliJ Plugin

- **Author:** [didalgolab](https://github.com/didalgolab)
- **License:** Apache-2.0
- **Source:** https://github.com/didalgolab/ai-intellij-plugin/blob/main/CLAUDE.md
