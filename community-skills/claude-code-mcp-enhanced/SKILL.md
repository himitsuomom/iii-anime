...
description: >-
  Provides detailed and emphatic instructions for Claude to follow as a coding agent, with testing
  guidance, code examples, and compliance checks. (CLAUDE.md File, via awesome-claude-code).
---

# claude-code-mcp-enhanced

- **Author:** [grahama1970](https://github.com/grahama1970)
- **License:** MIT
- **Source:** https://github.com/grahama1970/claude-code-mcp-enhanced/blob/main/CLAUDE.md
