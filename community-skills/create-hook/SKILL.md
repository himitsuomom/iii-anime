...
name: create-hook
description: >-
  Slash command for hook creation - intelligently prompts you through the creation process with
  smart suggestions based on your project setup (TS, Prettier, ESLint...). (Slash Command, via
  awesome-claude-code).
---

# /create-hook

- **Author:** [Omri Lavi](https://github.com/omril321)
- **License:** Apache-2.0
- **Source:** https://github.com/omril321/automated-notebooklm/blob/main/.claude/commands/create-hook.md
