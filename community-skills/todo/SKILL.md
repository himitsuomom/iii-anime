...
name: todo
description: >-
  A convenient command to quickly manage project todo items without leaving the Claude Code
  interface, featuring due dates, sorting, task prioritization, and comprehensive todo list
  management. (Slash Command, via awesome-claude-code).
---

# /todo

- **Author:** [chrisleyva](https://github.com/chrisleyva)
- **License:** MIT
