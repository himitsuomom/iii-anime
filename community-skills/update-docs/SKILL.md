...
name: update-docs
description: >-
  Reviews current documentation status, updates implementation progress, reviews phase documents,
  and maintains documentation consistency across the project. (Slash Command, via
  awesome-claude-code).
---

# /update-docs

- **Author:** [Consiliency](https://github.com/Consiliency)
- **License:** MIT
